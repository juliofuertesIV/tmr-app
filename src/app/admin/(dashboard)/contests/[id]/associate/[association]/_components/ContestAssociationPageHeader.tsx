import { Contest, ContestAssociationNames } from "@/types/contests";
...
export default function ContestAssociationPageHeader({ association, contest } : { association: ContestAssociationNames, contest: Contest }) {
