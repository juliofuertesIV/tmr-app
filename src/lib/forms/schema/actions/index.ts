...
const creationActions : CreationFormActionByCollection = {
    ...
    footers: () => getAddCollectionItemBoundAction({ collection: 'footers' }),
...
const updateActions : UpdateFormActionByCollection = {
    ...
    footers: ({ id } : { id: string }) => getUpdateCollectionItemBoundAction({ collection: 'footers', id }),
...
const deleteActions : DeleteFormActionByCollection = {
    ...
    footers: ({ id } : { id: string }) => getDeleteCollectionItemBoundAction({ collection: 'footers', id }),
